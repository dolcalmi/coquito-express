...
export default class {
    ...
    sendVerificationEmail( user, token ) {
        ...
        // hanlde the url and make a post with the token to /activate with activationToken param
    ...
    sendResetPasswordEmail( user, token ) {
        ...
        // you must replace this and use sendgrind, mailjet, ...
        // send an email with the token
        // hanlde the url and make a post with the token to /reset-password with resetPasswordToken param
        Promise.resolve(user);
    }
